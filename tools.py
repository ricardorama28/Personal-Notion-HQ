...
TOOLS = [
    {
        "name": "list_subjects",
        "description": "Lista las materias disponibles en Notion. Llamala primero si no estas seguro de los nombres exactos de las materias.",
        "input_schema": {"type": "object", "properties": {}}
    },
    {
        "name": "create_task",
        "description": "Crea una tarea nueva en la database Tasks. Si la tarea es de una materia, pasala en 'subject'.",
        "input_schema": {
            "type": "object",
            "properties": {
                ...
                "subject": {"type": "string", "description": "Nombre de la materia si aplica"},
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "subject": {"type": "string", "description": "Materia si aplica"}
            },
            "required": ["name", "date"]
        }
    },
    ...
    {
        "name": "add_note",
        "description": "Agrega un apunte a la sub-pagina 'Apuntes' de una materia. NUNCA sobreescribe, siempre agrega al final con un heading de fecha.",
        "input_schema": {
            "type": "object",
            "properties": {
                "subject": {"type": "string", "description": "Materia destino"},
    ...
    {
        "name": "create_diagram",
        "description": "Crea un diagrama de flujo como pagina nueva dentro de 'Diagramas' de una materia. El codigo debe ser Mermaid valido (flowchart, sequenceDiagram, stateDiagram, etc.).",
        "input_schema": {
            "type": "object",
            "properties": {
                "subject": {"type": "string"},
            ...
            "required": ["subject", "title", "mermaid_code"]
        }
    },
]
...
DISPATCH = {
    "list_subjects": ops.list_subjects,
